...
from app.models.models import Client, Firm, User
from app.schemas.client import ClientCreate, ClientOut
from app.api.deps import get_current_firm, get_or_404, get_current_user
from app.core.response import create_response
from app.services.pdf_generator import PDFReportGenerator
from app.services.client_context import build_report_payload
...
async def get_client_report(
    ...
    report_data = await build_report_payload(db, firm.id, client.id)
    ...
    return Response(
        ...
        headers={"Content-Disposition": f"attachment; filename=client_{client.id}_report.pdf"},
    )
