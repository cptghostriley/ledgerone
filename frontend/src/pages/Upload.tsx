      ...
      {isProcessing && (
        <div className="mx-6 mb-0 mt-4 flex items-center gap-3 rounded-xl border border-primary/30 bg-primary/8 px-5 py-3 md:mx-8">
          ...
          <p className="text-sm text-foreground">
            <strong>Processing with gemma4:e4b…</strong> Hang tight, the results page will open automatically.
          </p>
        </div>
      )}
        ...
        <Card className="h-fit border-border/70 bg-card p-5 shadow-elegant">
          ...
          <ol className="mt-4 space-y-3">
            {[
              ...
              { n: 2, title: "Schema extraction", desc: "gemma4:e4b maps the content to your selected schema fields." },
